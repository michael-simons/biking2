...
The images should be collected from https://dailyfratze.de[Daily Fratze], the source are all images that are tagged with "Radtour". In addition the user should be able to provide an "unlimited" number of "gallery pictures" together with a date and a short description.
