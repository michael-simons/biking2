...
[source,xml]
---------------------------------------------------------------------
include::../main/resources/wro.xml[tags=wro4jconcept]
---------------------------------------------------------------------
...
All business components use the _Simple Logging Facade for Java_ (SLF4J). The actual configuration of logging is configured through the means of Spring Boot. No special implementation is included manually, instead _biking2_ depends transitively on `spring-boot-starter-logging`.
